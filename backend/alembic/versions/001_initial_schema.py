...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS public.usage_logs CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.source_health CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.scan_logs CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.content_briefs CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.alert_triggers CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.alerts CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.prediction_factors CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.predictions CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.signal_events CASCADE;")
    op.execute("DROP TABLE IF EXISTS public.trends CASCADE;")
